...
const OUTPUT_DIR := "res://tmp/validation/customer_20_states_v1_gpu"
const STATES := [&"neutral", &"impatient", &"satisfied", &"accepting_bag", &"paying_coins"]
const EXPECTED_FILES := {
	&"neutral": "customer_20_neutral_v1_keyclean.png",
	&"impatient": "customer_20_impatient_v1_keyclean.png",
	&"satisfied": "customer_20_satisfied_v1_keyclean.png",
	&"accepting_bag": "customer_20_accepting_bag_v1_keyclean.png",
	&"paying_coins": "customer_20_paying_coins_v2_keyclean.png",
}
const EXPECTED_REGIONS := {
	&"neutral": Rect2(544, 74, 452, 877),
	&"impatient": Rect2(542, 64, 449, 872),
	&"satisfied": Rect2(557, 78, 424, 828),
	&"accepting_bag": Rect2(522, 85, 489, 868),
	&"paying_coins": Rect2(484, 71, 537, 900),
}
...
func _run() -> void:
	...
	for state in STATES:
		...
		for _frame in 3:
			await process_frame
		_check(portrait.texture != null and portrait.texture.resource_path.ends_with("customer_20_%s_cropped.tres" % state), "%s loads customer_20 AtlasTexture" % state)
		...
		var path := ProjectSettings.globalize_path("%s/customer_20_%s_1920x1080.png" % [OUTPUT_DIR, state])
...
func _finish() -> void:
	if _failures.is_empty():
		print("CUSTOMER_20_STATES_GPU_PREVIEW_PASS")
		quit(0)
		return
	printerr("CUSTOMER_20_STATES_GPU_PREVIEW_FAIL\n" + "\n".join(_failures))
	quit(1)
