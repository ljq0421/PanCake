...
const EXPECTED_REGIONS := {
	&"neutral": Rect2(495, 33, 541, 991),
	&"impatient": Rect2(473, 33, 558, 991),
	&"satisfied": Rect2(496, 37, 538, 987),
	&"accepting_bag": Rect2(528, 39, 476, 985),
	&"paying_coins": Rect2(544, 35, 482, 989),
}
