...
$checks = @(
	...
	'res://tests/unit/customer_handoff_tray_transaction_self_check.gd',
	...
	'res://tests/unit/packaged_drink_split_migration_self_check.gd',
	...
	'res://tests/integration/order_card_delivery_self_check.gd',
	'res://tests/integration/three_customer_delivery_self_check.gd',
	'res://tests/integration/order_card_requirements_self_check.gd',
	...
	'res://tests/integration/direct_steamer_station_contract_self_check.gd',
	'res://tests/integration/five_area_tutorial_guide_self_check.gd',
	'res://tests/integration/five_area_locked_visual_self_check.gd',
	'res://tests/integration/steamer_station_visual_self_check.gd',
