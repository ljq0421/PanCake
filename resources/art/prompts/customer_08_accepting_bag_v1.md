...
- References: `customer_08_neutral_v1.png`, customer 01 action pose reference, `paper_bag_package_v1.png`, `visual_style_anchor_v8.png`
- Source: `tmp/imagegen/customer_service_v1/customer_08_accepting_bag_v1_chromakey.png`
- Final: `res://resources/art/customers/customer_08/customer_08_accepting_bag_v1.png`
- Rejected/processing record: customer_08_accepting_bag_v1_rejected_bottom_crop.png (lower trouser edge touched the canvas)
- Chroma removal: skill `remove_chroma_key.py`, border auto-key, hard alpha, tolerance 60
- SHA-256: `1b1ba9b85e2b113c917d6c267474bb2000174195ed701d98e19dcb8d59a817ec`
