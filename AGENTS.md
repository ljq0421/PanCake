...
- 武汉为 2026-09-11 已确认收银交互特例：豆皮解锁前后分别使用 `武汉-热干面-v1.png`、`武汉-热干面-豆皮-v1.png`；完全沿用天津挂件收银规则，付款自动记账并飞币进入右侧挂件，点击查看本次营业明细并暂停营业，不再点击收钱。逐单评价仅保留本次营业，不写入存档；两城复用营业明细与飞币组件。
