...
const OUTPUT_DIR := "res://tmp/validation/customer_16_states_v1_gpu"
const STATES := [&"neutral", &"impatient", &"satisfied", &"accepting_bag", &"paying_coins"]
const EXPECTED_FILES := {
	&"neutral": "customer_16_neutral_v2_keyclean.png",
	&"impatient": "customer_16_impatient_v2.png",
	&"satisfied": "customer_16_satisfied_v1.png",
	&"accepting_bag": "customer_16_accepting_bag_v1.png",
	&"paying_coins": "customer_16_paying_coins_v1.png",
}
const EXPECTED_REGIONS := {
	&"neutral": Rect2(508, 18, 520, 1006),
	&"impatient": Rect2(507, 19, 512, 1005),
	&"satisfied": Rect2(506, 20, 521, 1004),
	&"accepting_bag": Rect2(502, 19, 531, 1005),
	&"paying_coins": Rect2(410, 20, 642, 1004),
}
...
func _run() -> void:
	...
	for state in STATES:
		...
		for _frame in 3:
			await process_frame
		_check(portrait.texture != null and portrait.texture.resource_path.ends_with("customer_16_%s_cropped.tres" % state), "%s loads customer_16 AtlasTexture" % state)
		...
		var path := ProjectSettings.globalize_path("%s/customer_16_%s_v1_1920x1080.png" % [OUTPUT_DIR, state])
...
func _finish() -> void:
	if _failures.is_empty():
		print("CUSTOMER_16_STATES_GPU_PREVIEW_PASS")
		quit(0)
		return
	printerr("CUSTOMER_16_STATES_GPU_PREVIEW_FAIL\n" + "\n".join(_failures))
	quit(1)
