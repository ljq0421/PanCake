...
- References: `customer_02_neutral_v1.png`, customer 01 action pose reference, `paper_bag_package_v1.png`, `visual_style_anchor_v8.png`
- Source: `tmp/imagegen/customer_service_v1/customer_02_accepting_bag_v1_chromakey.png`
- Final: `res://resources/art/customers/customer_02/customer_02_accepting_bag_v1.png`
- Rejected/processing record: customer_02_accepting_bag_v1_rejected_softmatte_alpha.png (warm skin was incorrectly removed by the dominance-based soft matte)
- Chroma removal: skill `remove_chroma_key.py`, border auto-key, hard alpha, tolerance 60
- SHA-256: `632bbfcdbfd39b69e98f1f6fec0a3746a1d3d8f092cdccbc4dccaeea559dccf4`
