...
const GROWTH_DEFINITIONS := {
	...
	&"growth.capacity.youtiao_finished_tray": {"label":"成品盘", "kind":&"storage", "price":50, "requires_area_id":&"area.youtiao", "requires_growth_ids":[&"growth.area.youtiao"], "anchor_id":&"youtiao.finished_tray"},
...
const PANCAKE_ORDER_TEMPLATES := {
	&"order.pancake.egg": {"title": "鸡蛋煎饼", "ingredient_stock_ids": [&"stock.pancake.egg"], "sauce_stock_ids": [], "time_limit": 68.0, "payment_coins": 12, "customer_line": "来一份鸡蛋煎饼，不加其他小料。"},
	&"order.pancake.double_egg_plain": {"title": "双蛋煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.egg"], "sauce_stock_ids": [], "time_limit": 72.0, "payment_coins": 18, "customer_line": "来一份双蛋煎饼，别加其他小料。"},
	&"order.pancake.no_egg_plain": {"title": "无蛋煎饼", "ingredient_stock_ids": [], "sauce_stock_ids": [], "time_limit": 64.0, "payment_coins": 6, "customer_line": "来一份无蛋煎饼，什么小料和酱都不加。"},
	&"order.pancake.no_egg_secret": {"title": "秘制酱料煎饼", "ingredient_stock_ids": [], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 66.0, "payment_coins": 6, "customer_line": "先来一份刷秘制酱料的无蛋煎饼。"},
	&"order.pancake.egg_sweet": {"title": "鸡蛋秘制酱料煎饼", "ingredient_stock_ids": [&"stock.pancake.egg"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 70.0, "payment_coins": 12, "customer_line": "鸡蛋煎饼刷秘制酱料就好。"},
	&"order.pancake.crisp": {"title": "薄脆煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.baocui"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 72.0, "payment_coins": 15, "customer_line": "加薄脆，刷秘制酱料，不要葱。"},
	&"order.pancake.classic": {"title": "经典杂粮煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.baocui", &"stock.pancake.scallion"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 72.0, "payment_coins": 18, "customer_line": "来一份经典的，薄脆和葱花都要。"},
	&"order.pancake.double_egg": {"title": "双蛋薄脆煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.egg", &"stock.pancake.baocui", &"stock.pancake.scallion"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 78.0, "payment_coins": 24, "customer_line": "鸡蛋加双份，薄脆和葱花照常。"},
	&"order.pancake.chili_simple": {"title": "葱香薄脆煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.baocui", &"stock.pancake.scallion"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 74.0, "payment_coins": 18, "customer_line": "薄脆和葱花都要，刷秘制酱料。"},
	&"order.pancake.chili_ham": {"title": "火腿薄脆煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.baocui", &"stock.pancake.ham_sausage"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 76.0, "payment_coins": 27, "customer_line": "火腿薄脆，刷秘制酱料。"},
	&"order.pancake.double_sauce": {"title": "全料秘制煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.baocui", &"stock.pancake.ham_sausage", &"stock.pancake.scallion"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 82.0, "payment_coins": 30, "customer_line": "刷秘制酱料，配料给我放匀。"},
	&"order.pancake.scallion_light": {"title": "葱香少料煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.scallion"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 68.0, "payment_coins": 15, "customer_line": "这份不加薄脆，保留葱花。"},
	&"order.pancake.meat_floss_sweet": {"title": "秘制肉松煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.baocui", &"stock.pancake.meat_floss", &"stock.pancake.scallion"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 84.0, "payment_coins": 30, "customer_line": "肉松铺匀些，秘制酱料和葱花都要。"},
	&"order.pancake.double_meat_floss": {"title": "双份肉松煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.baocui", &"stock.pancake.meat_floss", &"stock.pancake.meat_floss", &"stock.pancake.scallion"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 86.0, "payment_coins": 42, "customer_line": "肉松请给我加两份，秘制酱料和葱花都要。"},
	&"order.pancake.extra_sweet_sauce": {"title": "多秘制酱料煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.baocui", &"stock.pancake.scallion"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour", &"stock.pancake.sauce.sweet_flour"], "time_limit": 76.0, "payment_coins": 18, "customer_line": "秘制酱料加双份，薄脆和葱花都要。"},
	&"order.pancake.coriander": {"title": "香菜薄脆煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.baocui", &"stock.pancake.coriander"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 78.0, "payment_coins": 18, "customer_line": "薄脆和香菜都要，刷秘制酱料。"},
	&"order.pancake.tomato_ham": {"title": "火腿薄脆煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.baocui", &"stock.pancake.ham_sausage"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "time_limit": 78.0, "payment_coins": 27, "customer_line": "火腿薄脆，刷秘制酱料。"},
	&"order.pancake.youtiao_scallion": {"title": "油条葱香煎饼", "ingredient_stock_ids": [&"stock.pancake.egg", &"stock.pancake.youtiao", &"stock.pancake.scallion"], "sauce_stock_ids": [&"stock.pancake.sauce.sweet_flour"], "requires_recipe_ids": [&"recipe.youtiao.plain"], "time_limit": 72.0, "payment_coins": 24, "customer_line": "加一根油条、葱花和秘制酱料。"},
}
