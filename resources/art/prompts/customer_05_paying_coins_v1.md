...
- References: `customer_05_neutral_v1.png`, customer 01 action pose reference, `paper_bag_package_v1.png`, `currency_coin_v1.png`, `visual_style_anchor_v8.png`
- Source: `tmp/imagegen/customer_service_v1/customer_05_paying_coins_v1_chromakey.png`
- Final: `res://resources/art/customers/customer_05/customer_05_paying_coins_v1.png`
- Rejected/processing record: none; accepted first visual candidate after hard chroma extraction
- Chroma removal: skill `remove_chroma_key.py`, border auto-key, hard alpha, tolerance 60 (75 for customer_05 magenta-edge cleanup)
- SHA-256: `2e2b64e7e3a0dc6d240530bbd1c93e814d8055793b10b730b31de47add50c811`
