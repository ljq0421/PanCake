...
func _check_order_round_trip() -> void:
	...
	_check(ORDERS.customer_id_for_sequence(1) == &"customer_01" and ORDERS.customer_id_for_sequence(11) == &"customer_11" and ORDERS.customer_id_for_sequence(21) == &"customer_01", "ordinary customer rotation uses all twenty enabled portraits")
