...
const OUTPUT_DIR := "res://tmp/validation/customer_13_states_v1_gpu"
const STATES := [&"neutral", &"impatient", &"satisfied", &"accepting_bag", &"paying_coins"]
const EXPECTED_FILES := {
	&"neutral": "customer_13_neutral_v1.png",
	&"impatient": "customer_13_impatient_v1.png",
	&"satisfied": "customer_13_satisfied_v1.png",
	&"accepting_bag": "customer_13_accepting_bag_v1.png",
	&"paying_coins": "customer_13_paying_coins_v1.png",
}
const EXPECTED_REGIONS := {
	&"neutral": Rect2(545, 98, 436, 859),
	&"impatient": Rect2(562, 90, 417, 830),
	&"satisfied": Rect2(566, 97, 414, 826),
	&"accepting_bag": Rect2(548, 98, 421, 823),
	&"paying_coins": Rect2(486, 82, 553, 866),
}
...
func _run() -> void:
	...
	for state in STATES:
		...
		for _frame in 3:
			await process_frame
		_check(portrait.texture != null and portrait.texture.resource_path.ends_with("customer_13_%s_cropped.tres" % state), "%s loads customer_13 AtlasTexture" % state)
		...
		var path := ProjectSettings.globalize_path("%s/customer_13_%s_v1_1920x1080.png" % [OUTPUT_DIR, state])
...
func _finish() -> void:
	if _failures.is_empty():
		print("CUSTOMER_13_STATES_GPU_PREVIEW_PASS")
		quit(0)
		return
	printerr("CUSTOMER_13_STATES_GPU_PREVIEW_FAIL\n" + "\n".join(_failures))
	quit(1)
