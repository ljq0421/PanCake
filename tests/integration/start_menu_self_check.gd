...
func _run() -> void:
	...
	_check(background.texture != null and background.texture.resource_path == "res://resources/art/ui/start_menu/start_menu_background_v1.png", "start menu uses the generated project-local background")
