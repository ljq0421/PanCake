...
func _run() -> void:
	...
	_check(inventory.has("stock.pancake.batter") and inventory.has("stock.youtiao.plain_dough") and inventory.has("stock.fresh_soy_milk.yellow_bean"), "save preauthors stock counters for all three active areas")
