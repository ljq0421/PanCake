...
func _run() -> void:
	...
	_check(_growth_price(&"growth.automation.pancake.auto_batter_ladle") == 120 and _growth_price(&"growth.automation.pancake.press_once") == 120 and _growth_price(&"growth.automation.pancake.auto_sauce_brush") == 180, "pancake automation uses the approved prices")
