...
public partial class WuhanDayScreen
{
    ...
    private void BuildBusinessHud()
    {
        ...
        column.AddChild(WuhanUi.Label("计时、顾客耐心和工作台都已暂停。", 34, alignment: HorizontalAlignment.Center));
        column.AddChild(WuhanUi.Label("放弃后，本日收入与成绩不会保存。", 25, alignment: HorizontalAlignment.Center));
        ...
        _hudPauseTitleTape = IllustratedCityDialogTheme.BuildPause(panel, StableIds.Cities.Wuhan);
