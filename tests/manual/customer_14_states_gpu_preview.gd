...
const EXPECTED_REGIONS := {
	&"neutral": Rect2(532, 92, 465, 869),
	&"impatient": Rect2(538, 92, 446, 828),
	&"satisfied": Rect2(548, 112, 431, 804),
	&"accepting_bag": Rect2(524, 76, 487, 875),
	&"paying_coins": Rect2(444, 80, 609, 879),
}
