...
internal sealed class WuhanWorkbenchLayout
{
    ...
    public Rect2 Stock { get; } = Rect(1280, 732, 219, 145);
    public Rect2 StockFood { get; } = Rect(1298, 751, 184, 85);
    public Rect2 Batter { get; } = Rect(1450, 494, 180, 108);
    // Keep each complete inked spoon above the front rim of its ingredient tray.
    public Rect2 BatterLadle { get; } = Rect(1518, 509, 72, 58);
    public Rect2 DoupiEgg { get; } = Rect(1465, 603, 184, 116);
    public Rect2 DoupiEggFood { get; } = Rect(1533, 618, 68, 62);
    public Rect2 Knife { get; } = Rect(1500, 734, 151, 148);
