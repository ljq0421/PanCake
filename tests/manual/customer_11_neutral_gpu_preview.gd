...
const SCREENSHOT_PATH := "res://tmp/validation/customer_11_neutral_v1_chinese_gpu_1920x1080.png"
...
func _run() -> void:
	...
	_check(portrait != null and portrait.texture != null, "customer_11 neutral portrait loads in the real workstation")
...
func _finish() -> void:
	if _failures.is_empty():
		print("CUSTOMER_11_NEUTRAL_GPU_PREVIEW_PASS")
		quit(0)
		return
	printerr("CUSTOMER_11_NEUTRAL_GPU_PREVIEW_FAIL\n" + "\n".join(_failures))
	quit(1)
