...
public partial class WuhanRepairCapture : Node
{
    ...
    public override async void _Ready()
    {
        try
        {
            ...
            _day.DoupiAction(); await Advance(.18); await Shot("02-batter-action"); await Advance(.22);
            _day.DoupiAction(); await Advance(.18); await Shot("03-egg-action");
            ...
            _day.DoupiAction(); await Advance(.18); await Shot("06-filling-action"); await Advance(.23); await Shot("07-filling");
            ...
            await Shot("09-ready");
            Drag(view.PanCenter - new Vector2(50, 0), view.PanCenter + new Vector2(50, 0));
            await Advance(.18); await Shot("10-horizontal-cut"); await Advance(.22);
            Drag(view.PanCenter - new Vector2(0, 50), view.PanCenter + new Vector2(0, 50));
            ...
            _day.DoupiAction(); await Advance(.1); float paused = view.MotionProgress("pan");
