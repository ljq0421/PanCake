...
const EXPECTED_REGIONS := {
	&"neutral": Rect2(534, 89, 467, 855),
	&"impatient": Rect2(554, 80, 452, 837),
	&"satisfied": Rect2(535, 66, 461, 895),
	&"accepting_bag": Rect2(535, 97, 465, 838),
	&"paying_coins": Rect2(454, 86, 579, 860),
}
